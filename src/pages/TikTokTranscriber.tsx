...
export default function TikTokTranscriber() {
    ...
    description: "Transcribe TikTok Video to text instantly. Free, unlimited, no account required. AI-powered TikTok Video to text converter.",
    canonical: "https://luxetidestudio.com/tiktok-transcript",
    schema: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "TikTok Video Transcript Generator",
      "url": "https://luxetidestudio.com/tiktok-transcript",
      "description": "Free AI-powered TikTok Video transcription tool. Paste any URL and get accurate text in seconds.",
    ...
    >
      ...
      <div className="text-center py-16 md:py-24 px-5">
        ...
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[0.9] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          TikTok Video Transcript Generator
        </h1>
