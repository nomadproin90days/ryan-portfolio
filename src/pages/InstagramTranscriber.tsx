...
export default function InstagramTranscriber() {
    ...
    description: "Transcribe Instagram Reel to text instantly. Free, unlimited, no account required. AI-powered Instagram Reel to text converter.",
    canonical: "https://luxetidestudio.com/instagram-transcript",
    schema: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "Instagram Reel Transcript Generator",
      "url": "https://luxetidestudio.com/instagram-transcript",
      "description": "Free AI-powered Instagram Reel transcription tool. Paste any URL and get accurate text in seconds.",
